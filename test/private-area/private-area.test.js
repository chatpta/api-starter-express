...
describe( "Private-area/private-area", function () {
    ...
    it( "post '/private with jwt containing ['user'] role", function ( done ) {
    ...
    it( "post /private with jwt containing ['user', 'seller'] role", function ( done ) {
    ...
    it( "get /private with jwt containing ['user'] role", function ( done ) {
    ...
    it( "patch /private with jwt containing ['user', 'seller'] role", function ( done ) {
    ...
    it( "delete /private fails with jwt containing ['admin'] role", function ( done ) {
